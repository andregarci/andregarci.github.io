      ...
      <div className="main">
        ...
        <section id="about" className="about section">
          <div className="container section-title" data-aos="fade-up">
            <h2>Acerca de</h2>
            <p>
              Egresado de TECSUP en Diseño y Desarrollo de Software con
              experiencia en desarrollo backend y soluciones en la nube. Hábil
              en la resolución de problemas y adaptación a nuevas tecnologías.
            </p>
          </div>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <ul>
                      <li>
                        <i className="bi bi-chevron-right"></i>
                        <strong>Edad:</strong> <span>22</span>
                      </li>
                      <li>
                        <i className="bi bi-chevron-right"></i>
